...
Essentially, you are required to provide your API keys.
While it's not necessary to define `selectClass` and `selectMethod` in the POM file, you must specify them when executing `mvn chatunitest:method` or `mvn chatunitest:class`. This is done using the -D option.
